...
Combined_1 = combineCatVars(GenHealth_3, vars = c('HeartDiseaseorAttack', 'HighBP', 'HighChol'), sep = "_")
...
#  sep: the separator to combine the values of the variables in var 
library(iNZightTools)
Combined_2 = combineCatVars(GenHealth_3, vars = c('HeartDiseaseorAttack', 'HighBP'), sep = "_")
...
#  sep: the separator to combine the values of the variables in var 
library(iNZightTools)
Combined_3 = combineCatVars(GenHealth_3, vars = c('HeartDiseaseorAttack', 'HighChol'), sep = "_")
